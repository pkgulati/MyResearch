...
//        });
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            try {
                String URL = ApplicationData.baseUrl + "/api/login";
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
                    ...
                    public void onResponse(String str) {
                        ...
                        try {
                            ...
                            Log.e(ApplicationData.TAG, "Could not parse malformed JSON: \"" + str + "\"");
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Log.e(ApplicationData.TAG, "onErrorResponse");
                        showProgress(false);
                        mLoginInProgress = false;
                        String message = null;
                        ...
                        Log.e(ApplicationData.TAG, "Error pkg");
                        Log.e(ApplicationData.TAG, statusCode);
                    ...
                    public byte[] getBody() throws AuthFailureError {
                        try {
                            ...
                            Log.d(ApplicationData.TAG, "Unsupported Encoding ");
                            return null;
                        }
                    }
                };
                ...
                Log.d(ApplicationData.TAG, "Request added");
            } catch (JSONException e) {
                Log.d(ApplicationData.TAG, "Json exception ");
            }
        }
    }
